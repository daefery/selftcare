...
uis.directive('uiSelectChoices',
  ...
  return {
    ...
    replace: true,
    transclude: true,
    template: function(tElement, attr) {
      // Gets theme attribute from parent (ui-select)
        //var theme = tElement.parent().attr('theme') || uiSelectConfig.theme;
        var tmplt = "<ul class=\"ui-select-choices ui-select-choices-content select2-results\">" +
            ...
            "<li role=\"option\" id=\""+attr["id"]+"_{{$index}}\" class=\"ui-select-choices-row\" ng-class=\"{\'select2-highlighted\': $select.isActive(this), \'select2-disabled\': $select.isDisabled(this)}\">" +
...
uis.directive('uiSelectMatch', ['uiSelectConfig', function (uiSelectConfig) {
  return {
    ...
    template: function (tElement, attrs) {
        //var dfl = 'select2-default';
        //var error = 'error';
        //var temp = '{ ' + dfl + ': $select.isEmpty(), ' + error + ': ' + attrs['id'] + '.$submitted }';// "{select2-default: $select.isEmpty(), error: " + attrs['id'] + ".$submitted}";
        var txt = attrs['id'];
        var id = txt.split('.');
      ...
      var tmplt = "<a class=\"select2-choice ui-select-match\" ng-class=\"{\'select2-default\': $select.isEmpty(), \'error\': " + id[0] + ".$submitted && " + id[0] + "." + id[1] + ".$invalid }\" ng-click=\"$select.toggle($event)\" aria-label=\"{{ $select.baseTitle }} select\">"+
          ...
          "<span class=\"select2-arrow ui-select-toggle\"><b></b></span></a>";//theme + (multi ? '/match-multiple.tpl.html' : '/match.tpl.html');
      return tmplt; //theme + (multi ? '/match-multiple.tpl.html' : '/match.tpl.html');
    },
...
angular.module("ui.select").run(["$templateCache", function ($templateCache) {
    ...
    $templateCache.put("select2/select.tpl.html", "<div class=\"ui-select-container select2 select2-container\" ng-class=\"{\'select2-container-active select2-dropdown-open open\': $select.open, \'select2-container-disabled\': $select.disabled, \'select2-container-active\': $select.focus, \'select2-allowclear\': $select.allowClear && !$select.isEmpty()}\"><div class=\"ui-select-match\"></div><div class=\"ui-select-dropdown select2-drop select2-with-searchbox select2-drop-active\" ng-class=\"{\'select2-display-none\': !$select.open}\"><div class=\"select2-search\" ng-show=\"$select.searchEnabled\"><input id=\"test\" type=\"text\" autocomplete=\"false\" autocorrect=\"false\" autocapitalize=\"off\" spellcheck=\"false\" role=\"combobox\" aria-expanded=\"true\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" aria-label=\"{{ $select.baseTitle }}\" aria-activedescendant=\"ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}\" class=\"ui-select-search select2-input\" ng-model=\"$select.search\"></div><div class=\"ui-select-choices\"></div></div></div>");
