//Version of this slick.js is unknown
//Need to be updated into obvious version
! function (a) {
    "use strict";
    ...
    b = function () {
        ...
        var b = this;
        b.options.arrows === !0 && b.slideCount > b.options.slidesToShow && (b.$prevArrow = a('<button type="button" class="slick-prev" tabIndex="-1">Previous</button>').appendTo(b.$slider), b.$nextArrow = a('<button type="button" class="slick-next" tabIndex="-1">Next</button>').appendTo(b.$slider), b.options.infinite !== !0 && b.$prevArrow.addClass("slick-disabled"))
    }, b.prototype.buildDots = function () {
        var c, d, b = this;
        if (b.options.dots === !0 && b.slideCount > b.options.slidesToShow) {
            for (d = '<ul class="slick-dots">', c = 0; c <= b.getDotCount() ; c += 1) d += '<li><a href="javascript:void(0)" tabIndex="-1">' + c + "</a></li>";
            d += "</ul>", b.$dots = a(d).appendTo(b.$slider), b.$dots.find("li").first().addClass("slick-active")
        }
    }, b.prototype.buildOut = function () {
        var b = this;
        b.$slides = b.$slider.children(b.options.slide + ":not(.slick-cloned)").addClass("slick-slide"), b.slideCount = b.$slides.length, b.$slidesCache = b.$slides, b.$slider.addClass("slick-slider"), b.$slideTrack = 0 === b.slideCount ? a('<div class="slick-track"/>').appendTo(b.$slider) : b.$slides.wrapAll('<div class="slick-track"/>').parent(), b.$list = b.$slideTrack.wrap('<div class="slick-list"/>').parent(), b.$slideTrack.css("opacity", 0), b.options.accessibility === !0 && b.$list.prop("tabIndex", 0), b.options.centerMode === !0 && (b.options.infinite = !0, b.options.slidesToScroll = 1, 0 === b.options.slidesToShow % 2 && (b.options.slidesToShow = 3)), a("img[data-lazy]", b.$slider).not("[src]").addClass("slick-loading"), b.setupInfinite(), b.buildArrows(), b.buildDots(), b.setSlideClasses(0), b.options.draggable === !0 && b.$list.addClass("draggable")
        ...
        var b = this;
        b.options.dots === !0 && b.slideCount > b.options.slidesToShow && a("li a", b.$dots).on("click.slick", {
            message: "index"
        }, b.changeSlide)
        ...
        b.initArrowEvents(), b.initDotEvents(), b.$list.on("touchstart.slick mousedown.slick", {
            ...
            action: "end"
        }, b.swipeHandler), b.$list.on("dragstart.slick", function (a) {
            a.preventDefault()
        ...
        b.setPosition(), b.$slideTrack.css({
            opacity: 1
        }), "complete" !== document.readyState ? a(window).load(function () {
        ...
        var a = this;
        a.options.centerMode === !0 ? a.$list.find(".slick-slide").width(a.slideWidth) : a.$list.find(".slick-slide").width(a.slideWidth), a.options.vertical === !1 ? (a.$slideTrack.width(Math.ceil(a.slideWidth * a.$slider.find(".slick-slide").length)), a.options.centerMode === !0 && a.$list.css({
        ...
        if ((b.options.fade === !0 || b.options.vertical === !0) && (b.options.slidesToShow = 1, b.options.slidesToScroll = 1, b.options.centerMode = !1), b.options.infinite === !0 && b.options.fade === !1 && (d = null, b.slideCount > b.options.slidesToShow)) {
            for (e = b.options.centerMode === !0 ? b.options.slidesToShow + 1 : b.options.slidesToShow, c = b.slideCount; c > b.slideCount - e; c -= 1) d = c - 1, a(b.$slides[d]).clone().prependTo(b.$slideTrack).addClass("slick-cloned");
            for (c = 0; e > c; c += 1) d = c, a(b.$slides[d]).clone().appendTo(b.$slideTrack).addClass("slick-cloned")
        }
