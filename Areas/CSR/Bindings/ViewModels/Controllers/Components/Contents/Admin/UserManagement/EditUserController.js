...
CSRContent.controller('ViewUserDetailController', function ($scope, $modal, $q, $http, $location, $filter, ApiConnection, GetUserDetail, UserDetailUtility, GetRolebyMVNOIdService, CreateRoleUserService, Notification, AssignRoleTreeService, GetUserRolesService, GetDealerbyMvnoService, AssignDealerService, GetMvnoDetailService, GetDepartmentbyUserDealerIdService, AssignUserDeptService, GetUserDeptbyIdService, LocalStorageProvider, CSRCache, CacheAdmin, DealerMvnoDetailService, SelfUpdateService, GetRolebyMVNOIdActiveOnlyService, CSRSecureSection) {
    $scope.isNoDept = null;
...
CSRContent.controller('EditUserDetailFormController', function ($scope, $route, $http, $window, $location, ChangeUserDetail, GetUserDetail, UserDetailUtility, Notification) {
    $scope.return = function () {
        window.location.href = '/CSR/Customer/App/Admin/UserManagement';
    }

    $scope.isFormChanged = function () {
        return !angular.equals($scope.products, $scope.editmodaldata);
    };
...
CSRContent.controller('ChangeEmailFormController', function ($scope, $route, $http, $window, $location, ChangeUserEmail, UserDetailUtility, Notification) {
