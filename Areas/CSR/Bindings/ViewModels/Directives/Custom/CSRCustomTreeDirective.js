...
treeControl.constant('treeConfig', {
    templateUrl: null
})

treeControl.directive('treecontrol', ['$compile', function ($compile) {
    /**
...
treeControl.directive("setNodeToData", ['$parse', function ($parse) {
    return {
        restrict: "EA",
...
treeControl.directive("treeitem", function () {
        return {
            restrict: "EA",
            require: "^treecontrol",
...
treeControl.directive("treeTransclude", function () {
        return {
